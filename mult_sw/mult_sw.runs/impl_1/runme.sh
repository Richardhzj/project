...
HD_PWD='/nfs/nfs7/home/huang238/mult_sw/mult_sw.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_sw.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mult_sw.tcl -notrace
