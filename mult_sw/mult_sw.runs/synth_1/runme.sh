...
HD_PWD='/nfs/nfs7/home/huang238/mult_sw/mult_sw.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mult_sw.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mult_sw.tcl
