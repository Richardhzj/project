...
HD_PWD='/nfs/nfs7/home/huang238/lab10/lab10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log two7segment.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source two7segment.tcl
