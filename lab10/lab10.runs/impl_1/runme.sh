...
HD_PWD='/nfs/nfs7/home/huang238/lab10/lab10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log two7segment.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source two7segment.tcl -notrace
