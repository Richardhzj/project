...
void *exp, *env, *k, *rator, *randr__m__o, *v, *vari;
...
struct expr {
  ...
  union {
    ...
    struct { void *_rator; void *_randr__m__o; } _app;
  } u;
};
...
struct kt {
  ...
  union {
    ...
    struct { void *_envr__m__cps; void *_randr__m__o; void *_k; } _appr__m__outerr__m__k;
