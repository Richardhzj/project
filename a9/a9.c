...
void *ktr_appr__m__outerr__m__k(void *envr__m__cps, void *randr__m__o, void *k) {
kt* _data = (kt*)malloc(sizeof(kt));
if(!_data) {
  fprintf(stderr, "Out of memory\n");
  exit(1);
  ...
  _data->u._appr__m__outerr__m__k._randr__m__o = randr__m__o;
...
void *exprr_app(void *rator, void *randr__m__o) {
expr* _data = (expr*)malloc(sizeof(expr));
if(!_data) {
  fprintf(stderr, "Out of memory\n");
  exit(1);
  ...
  _data->u._app._randr__m__o = randr__m__o;
  return (void *)_data;
}
...
exp = (void *)body;
env = (void *)envrr_extendr__m__env(randr__m__o,envr__m__cps);
pc = &valuer__m__ofr__m__cps;
break; }
}
}
...
void *randr__m__o = _c->u._appr__m__outerr__m__k._randr__m__o;
void *kx = _c->u._appr__m__outerr__m__k._k;
exp = (void *)randr__m__o;
env = (void *)envr__m__cps;
...
void *randr__m__o = _c->u._app._randr__m__o;
exp = (void *)rator;
k = (void *)ktr_appr__m__outerr__m__k(env,randr__m__o,k);
pc = &valuer__m__ofr__m__cps;
break; }
}
}
