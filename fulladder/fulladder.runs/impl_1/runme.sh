...
HD_PWD='/nfs/nfs7/home/huang238/fulladder/fulladder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hierarchical_fulladder.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hierarchical_fulladder.tcl -notrace
