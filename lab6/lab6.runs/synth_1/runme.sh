...
HD_PWD='/nfs/nfs7/home/huang238/fulladder/fulladder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hierarchical_fulladder.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hierarchical_fulladder.tcl
